import numpy as np
import h5py
from stokeslet_solver import compute_flow_field_over_time_steady
...
if __name__ == "__main__":
    ...
    velocity_4D_array = compute_flow_field_over_time_steady(
    ...
    # Save the data
    output_filename = 'single_sperm_flow_field_steady.h5'
